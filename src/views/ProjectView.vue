<template>
  <div
    class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 bg-gray-200 dark:bg-gray-900 dark:text-white rounded-md shadow-md"
    data-aos="fade-up"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      >
        ...
        <div class="p-4">
          ...
          <p class="text-gray-700 dark:text-gray-400">A Game made with Unreal Engine 5 and C++</p>
          <a
            href="https://github.com/Glanceman/FYP"
      ...
      >
        ...
        <div class="p-4">
          ...
          <a
            href="https://github.com/Glanceman/VRProject"
            class="mt-4 inline-block px-4 py-2 bg-blue-500 text-white rounded-full transition duration-500 hover:bg-blue-600 hover:shadow-md transform hover:-translate-y-1"
            >View project</a
          >
        </div>
      ...
      >
        ...
        <div class="p-4">
          ...
          <a
            href="https://glanceman.github.io/SM2278-EnhancedMusicPlayer/"
            class="mt-4 inline-block px-4 py-2 bg-blue-500 text-white rounded-full transition duration-500 hover:bg-blue-600 hover:shadow-md transform hover:-translate-y-1"
            >View project</a
          >
        </div>
      ...
      >
        ...
        <div class="p-4">
          ...
          <p class="text-gray-700 dark:text-gray-400">UX/UI design for the telemedic system</p>
          <a
            href="https://www.figma.com/proto/fJLtZTmDyO1lld53LnMuM1/CS3483?node-id=0-1"
            class="mt-4 inline-block px-4 py-2 bg-blue-500 text-white rounded-full transition duration-500 hover:bg-blue-600 hover:shadow-md transform hover:-translate-y-1"
            >View project</a
          >
        </div>
      ...
      >
        ...
        <div class="p-4">
          ...
          <a
            href="https://www.figma.com/file/AYsWLXiT4ard9hV6uQzjvu/Cs3347-Group-Project?node-id=8-188&t=gD6zSKOkzzmRStFM-0"
            class="mt-4 inline-block px-4 py-2 bg-blue-500 text-white rounded-full transition duration-500 hover:bg-blue-600 hover:shadow-md transform hover:-translate-y-1"
            >View project</a
          >
        </div>
