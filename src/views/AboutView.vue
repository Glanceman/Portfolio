    ...
    <div class="flex flex-col lg:flex-row">
      ...
      <div class="w-full lg:w-2/3 p-4 mx-auto">
        <div class="w-full" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
          <h1
            class="mb-4 text-2xl font-extrabold text-transparent lg:text-3xl bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">
            Introduction</h1>
          <p class="text-gray-700 dark:text-gray-400 mb-4">
            Welcome to my portfolio website! I am a creative meida student with a passion for programming. Here, you'll
            find examples of my work in languages like Java, Python, and C++, as well as web development technologies like
            HTML, CSS, and JavaScript. I am always eager to learn and grow as a programmer, and I hope my work reflects
        ...
        <div class="w-full" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
          ...
          <a  class="text-gray-700 dark:text-gray-400 mb-4" href="https://github.com/Glanceman">Github</a>
          <span> | </span>
          <a  class="text-gray-700 dark:text-gray-400 mb-4" href="https://www.linkedin.com/in/ben-xian-5831a5228/">Linkedin</a>
        </div>
      </div>
    </div>
  </div>
